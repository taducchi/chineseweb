                        ...
                        <div className="flex-1 flex flex-col p-4 md:p-6 lg:p-8 max-w-4xl mx-auto w-full">
                                ...
                                <div className="flex justify-between items-center mt-4 gap-3">
                                        <button
                                                ...
                                                className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl text-sm sm:text-base font-medium transition-all ${currentCard === 0 || isFlipped
                                        ...
                                        <button
                                                ...
                                                className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl text-sm sm:text-base font-medium transition-all ${currentCard === cards.length - 1 || isFlipped
                                                                ? 'opacity-40 cursor-not-allowed text-text-sub'
                                                                : 'hover:bg-slate-100 dark:hover:bg-slate-800 text-text-main'
                                                        }`}
                                        >
