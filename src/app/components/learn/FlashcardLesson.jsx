...
export default function FlashcardLesson({ data, course_slug, module_slug, lesson_slug, lesson_course, item_slug }) {
        ...
        const toggleFullscreen = async (e) => {
                ...
                try {
                        ...
                        console.error('Lỗi chuyển đổi toàn màn hình:', err);
                }
        };
        ...
        }, [handleRating, goToPrevCard, goToNextCard, isFullscreen]);
        ...
        return (
                <main className="flex-1 flex flex-col min-h-screen bg-background-light dark:bg-background-dark overflow-y-auto">
                        <div className="flex-1 flex flex-col p-4 md:p-6 lg:p-8 max-w-4xl mx-auto w-full">
                                ...
                                {/* ===== KHỐI FULLSCREEN: gồm Progress + Timer + Streak + Card + Navigation ===== */}
                                <div
                                        ref={fullscreenRef}
                                        className={`flex flex-col ${isFullscreen
                                                        ? 'bg-background-light dark:bg-background-dark p-4 sm:p-6 md:p-8 w-full h-full'
                                                        : ''
                                                }`}
                                >
                                        {/* Progress & Timer */}
                                        ...
                                        >
                                                ...
                                                <button
                                                        ...
                                                        className="absolute top-3 right-3 z-20 flex items-center justify-center w-10 h-10 rounded-full bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm text-text-sub hover:text-primary hover:bg-white dark:hover:bg-slate-700 shadow-md transition-all active:scale-95"
                                                                ...
                                                                <div className="flex-1 flex flex-col items-center justify-center gap-4 sm:gap-6">
                                                                        ...
                                                                        {currentCardData.audio_file && (
                                                                                <button
                                                                                        ...
                                                                                        className={`relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full transition-all duration-300 flex-shrink-0 ${isPlaying
                                                                                ...
                                                                                >
                                                                                        <span className={`material-symbols-outlined text-3xl sm:text-4xl md:text-5xl transition-all duration-300 ${isPlaying ? 'animate-pulse' : ''
                                                                                                }`}>
                                        ...
                                        <div className="flex justify-between items-center mt-4 gap-3">
                                                <button
                                                        ...
                                                        className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl text-sm sm:text-base font-medium transition-all ${currentCard === 0
                                                ...
                                                <button
                                                        ...
                                                        className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl text-sm sm:text-base font-medium transition-all ${currentCard === cards.length - 1
                                                                        ? 'opacity-40 cursor-not-allowed text-text-sub'
                                                                        : 'hover:bg-slate-100 dark:hover:bg-slate-800 text-text-main'
                                                                }`}
                                                >
                                ...
                                {/* ===== KẾT THÚC KHỐI FULLSCREEN ===== */}

                                {/* Link chuyển sang chế độ Vocabulary - đặt dưới cùng */}
                                <div className="flex justify-center mt-5">
                                        <Link
                                                href={`/learn/courses/${course_slug}/${module_slug}/vocabulary/${lesson_course}`}
                                                className="group flex items-center gap-2 px-5 py-3 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-text-main dark:text-white font-semibold text-sm sm:text-base hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-primary/40 transition-all active:scale-[0.98]"
                                        >
                                                <span className="material-symbols-outlined text-lg text-primary">apps</span>
                                                <span>Chọn chế độ luyện tập khác</span>
                                                <span className="material-symbols-outlined text-lg text-text-sub group-hover:translate-x-0.5 transition-transform">arrow_forward</span>
                                        </Link>
                                </div>
                                ...
                                <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-4 text-xs text-text-sub/60">
                                        ...
                                        <span className="flex items-center gap-1">
                                                <kbd className="px-1.5 py-0.5 rounded bg-slate-200 dark:bg-slate-700 font-mono text-[10px]">F</kbd>
                                                Toàn màn hình
                                        </span>
                                </div>
                        </div>
