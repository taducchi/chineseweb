                                                        ...
                                                        {activeTab === 'vocabulary' && (
                                                                <div className="flex flex-col bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm">
                                                                        ...
                                                                        <div className="border-b border-border-light dark:border-border-dark">
                                                                                {/* Mobile: Grid 2x2 */}
                                                                                <div className="grid grid-cols-2 md:hidden p-2 gap-1.5">
                                                                                        {tabs.map((tab) => (
                                                                                                <button
                                                                                                        key={tab.id}
                                                                                                        onClick={() => setActiveTab(tab.id)}
                                                                                                        className={`
                        relative px-3 py-2.5 text-xs font-bold transition-all rounded-lg
                        ${activeTab === tab.id
                    ...
                    `}
                                                                                                >
                                                                                                        <div className="flex items-center justify-center gap-1">
                                                                                                                {tab.label}
                                                                                                                {tab.badge && (
                                                                                                                        <span className="bg-border-light dark:bg-border-dark px-1.5 py-0.5 rounded text-[10px]">
                                                                                                                                {tab.badge}
                                                                                                                        </span>
                                                                                                                )}
                                                                                                        </div>
                                                                                        ...
                                                                                        <div className="flex min-w-full">
                                                                                                {tabs.map((tab) => (
                                                                                                        <button
                                                                                                                ...
                                                                                                                onClick={() => setActiveTab(tab.id)}
                                                                                                                className={`
                            relative px-6 py-4 text-sm font-bold whitespace-nowrap transition-colors flex-shrink-0
                            ${activeTab === tab.id
                                                                                                                                ? 'text-primary'
                                                                                                                                : 'text-text-sub-light dark:text-text-sub-dark hover:text-text-main-light dark:hover:text-text-main-dark hover:bg-background-light dark:hover:bg-border-dark'
                                                                                                                        }
