...
export default function IntroCourseCard({ course, link }) {

    const isSpecialCourse = course.slug === "hsk-4-thanh-thao-giao-tiep-trung-cap";
    return (
            ...
            <div className="flex flex-col flex-1 p-5">
                ...
                <div className="flex gap-3 mt-auto">
                    <div className="flex-1">
                        ...
                        >
                            {isSpecialCourse ? 'Học ngay' : 'Tìm hiểu ngay'}
                        </Link>
                    </div>
