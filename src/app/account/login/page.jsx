...
export default function LoginPage() {
        ...
        {/* Main Content */}
        <main className="flex-grow flex items-center justify-center px-4 sm:px-4 sm:py-6 lg:py-12">
                <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white dark:bg-surface-dark rounded-xl sm:rounded-2xl shadow-xl overflow-hidden lg:min-h-[600px]">
                        ...
                        <div className="flex flex-col justify-center items-center px-5 py-3 sm:px-6 sm:py-8 md:px-12 lg:px-16 w-full min-h-0 lg:min-h-screen bg-slate-50 dark:bg-slate-950">
                                <div className="w-full max-w-md">

                                        {/* ─── HEADER ─── */}
                                        <div className="mb-3 sm:mb-6 lg:mb-8 text-center lg:text-left">
                                                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 dark:text-white mb-1 sm:mb-2 tracking-tight">
                                                        Chào mừng trở lại!
                                                </h1>
                                        ...
                                        {/* ─── DIVIDER ─── */}
                                        <div className="relative my-3 sm:my-6 lg:my-8">
                                        ...
                                        {/* ─── REGISTER LINK ─── */}
                                        <div className="mt-3 sm:mt-6 lg:mt-8 text-center">
